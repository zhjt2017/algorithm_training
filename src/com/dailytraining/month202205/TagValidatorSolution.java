...
/**
 * 算法训练(2022-05-02) 标签验证器
 * - https://leetcode-cn.com/problems/tag-validator/ (591题)
 * <p>
 ...
 * 合法的 TAG_CONTENT 可以包含其他合法的闭合标签，cdata （请参考规则7）和任意字符（注意参考规则1）除了不匹配的<、不匹配的起始和结束标签、不匹配的或带有不合法 TAG_NAME 的闭合标签。
 ...
 * @since 2022-05-02 07:05:43
 */
public class TagValidatorSolution {
    public static void main(String[] args) {
        final TagValidatorSolution solution = new TagValidatorSolution();

        String code = "<DIV>This is the first line <![CDATA[<div>]]></DIV>";
        System.out.println("Input code : " + code);
        System.out.println("Output is valid : " + solution.isValid(code));
        System.out.println();
    ...
    private boolean move() {
        ...
        if (code.charAt(i) == '!') {
            ...
            if (!"[CDATA[".equals(code.substring(i + 1, i + 8))) {
                return false;
            }
            int j = code.indexOf("]]>", i);
            if (j < 0) {
