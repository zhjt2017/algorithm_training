...
/**
 * 算法实现：字典树 - 系统设计：搜索提示 (自动补全)
 * - https://leetcode-cn.com/problems/design-search-autocomplete-system/ (642题)
 * <p>
...
public class DesignSearchAutocompleteSystemSolution {
    public static void main(String[] args) {
        ...
        System.out.println("AutocompleteSystem initialization, sentences : " + Arrays.toString(sentences) + ", times : " + Arrays.toString(times));
        System.out.println("input : i, result : " + autocompleteSystem.input('i'));
        System.out.println("input :  , result : " + autocompleteSystem.input(' '));
        System.out.println("input : a, result : " + autocompleteSystem.input('a'));
        System.out.println("input : #, result : " + autocompleteSystem.input('#'));
